...
```javascript
Levy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-levy-ctor@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-levy-ctor@umd/bundle.js"></script>
```
